...
/**
 * Consider all Verbs, no only V-FIN
 * Higher weight on Adjectives?
 * 
 * 
 * @author hfernandes
 *
 */
public class Sentiment6 {
...
//						}
						...
						//proximity
//						if(sentence.getAlvoToken() < token.getIndex()+9 && sentence.getAlvoToken() > token.getIndex()-9){
						...
						if(token.getType().equals("N")){
							...
							if(lexiconMap.containsKey(key)){
								...
								polarity += token.getPolarity()*0.5;
							}
						}	
						...
						if(token.getType().startsWith("V-")){
							...
							if(lexiconMap.containsKey(key)){
								...
								polarity += token.getPolarity()*0.2;
							}
						}	
...
//					}
	...
	public static void main(String args[]) throws Exception {
		...
		String INPUT = "output/SentiCorpus-PT_ner_3.xml";
		String OUTPUT = "output/SentiCorpus-PT_sentiment_6.xml";
